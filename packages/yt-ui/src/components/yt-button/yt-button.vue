...
import type { ColorType, SizeType } from '../../types/prop-types'
...
<template>
  <button :class="buttonClass" :loading="loading" hover-class="yt-button--hover" @click="handleClick">
    <span v-if="loading" class="yt-button--loading"></span>
