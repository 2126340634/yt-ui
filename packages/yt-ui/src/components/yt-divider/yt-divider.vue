...
<template>
  <view v-if="hasContent" class="yt-divider--container" :style="dividerContainerStyle">
    <view :class="[...dividerClass, 'start-line']" :style="dividerStyle" />
    <span :style="textStyle">
      <slot />
    </span>
    <view :class="[...dividerClass, 'end-line']" :style="dividerStyle" />
  </view>
  <view v-else :class="[...dividerClass, 'single-line']" :style="singleDividerStyle" />
</template>
