...
<template>
  <view :class="dotsClass" :style="dotsStyle">
    <view v-for="(_, index) in total" :key="index" :class="getDotsItemOuterClass(index)">
      <view class="yt-dots--item-inner" :style="getDotsItemInnerStyle(index)" />
    </view>
  </view>
</template>
