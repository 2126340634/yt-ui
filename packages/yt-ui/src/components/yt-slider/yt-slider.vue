...
<template>
  <slider :min="min" :max="max" :step="step" :disabled="disabled" :value="currentValue" :show-value="showValue" :block-size="blockSize" @change="handleChange" @changing="handleChanging" />
</template>
