...
<template>
  <view :class="noticeBarClass" :style="noticeBarStyle">
    <view v-if="hasSlots.hasPrefix" class="yt-notice-bar--prefix" :style="{ flex: prefixFlex }">
      <slot name="prefix" />
    </view>
    <view class="yt-notice-bar--text-container">
      <span class="yt-notice-bar--text" :style="noticeTextStyle">
        <slot />
      </span>
    </view>
    <view v-if="hasSlots.hasSuffix" class="yt-notice-bar--suffix" :style="{ flex: suffixFlex }">
      <slot name="suffix" />
    </view>
  </view>
</template>
